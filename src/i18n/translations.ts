...
const translations = {
  fr: {
    ...
    ind_pension: 'Cotisations retraite pendant le cong\u00e9',
    ...
    pension_rights: 'Droits à la retraite',
    pension_yes: 'Cotisations maintenues pendant le congé',
    pension_no: 'Cotisations non maintenues',
    pension_unknown: 'Information non disponible',
    ...
    compare_row_pension: 'Cotisations retraite',
  ...
  en: {
    ...
    ind_pension: 'Pension contributions during leave',
    ...
    pension_rights: 'Pension rights',
    pension_yes: 'Contributions maintained during leave',
    pension_no: 'Contributions not maintained',
    pension_unknown: 'Information not available',
    ecec: 'Childcare (ECEC)',
    ...
    compare_row_pension: 'Pension contributions',
